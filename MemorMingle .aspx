<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MemorMingle .aspx.vb" Inherits="MemorMingle_" %>
...
<body>
   <nav class="navbar navbar-default navbar-fixed-top visible-h">
      <div class="container">
          ...
          <div class="pull-left">
              <div class="dropdown greenbottonholder">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dLabel">
                    <li class="dropdown-header"><i> </i>  My Household </li>
                    <ul id="namescroll">

                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> Elizabeth</a></li>
                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> tony</a></li>
                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> Elizabeth</a></li>
                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> tony</a></li>
                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> Elizabeth</a></li>
                    <li><a href="#"><i><img src="images/user-icon.png" alt=""></i> tony</a></li>
                    ...
                    <li class="dropdown-footer"><a href="#"><i> </i> Add more</a></li>
                  </ul>
          ...
          <ul class="nav navbar-nav navbar-right custom-tommenu">
          	<li>
                ...
                <div class="input-group col-md-12">
                    <input type="text" class="form-control typeahead" placeholder="Find a Memory" />
            ...
            <li class="dropdown active"><a class="dropdown-toggle" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" href="#"><span><i><img src="images/icon-memorebook.png" alt=""></i></span></a>
            	<ul class="dropdown-menu">
                     <li><a href="Household-Members.aspx">My Household</a></li>
                    <li><a href="#">Friends &amp; relatives</a></li>
                    <li><a href="#">Notifications</a></li>
                    <li><a href="#">Sign Out</a></li>
              </ul>
            </li>
            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" href="#"><span data-toggle="tooltip" data-placement="bottom" title="memorExchange "><i><img src="images/icon-memoremingle.png" alt=""></i></span></a>
            	<ul class="dropdown-menu">
                     <li><a href="Household-Members.aspx">My Household</a></li>
                    <li><a href="#">Friends & relatives</a></li>
                    <li><a href="#">Notifications</a></li>
            ...
            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" href="#"><span data-toggle="tooltip" data-placement="bottom" title="memorEmingle"><i><img src="images/icon-memorexchange.png" alt=""></i></span></a>
            	<ul class="dropdown-menu">
                     <li><a href="Household-Members.aspx">My Household</a></li>
                    <li><a href="#">Friends & relatives</a></li>
                    <li><a href="#">Notifications</a></li>
            ...
            <li class="dropdown"><a class="dropdown-toggle" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" href="#"><span data-toggle="tooltip" data-placement="bottom" title="Settings"><i><img src="images/icon-memoresetting.png" alt=""></i></span></a>
            	<ul class="dropdown-menu">
                     <li><a href="Household-Members.aspx">My Household</a></li>
                    <li><a href="#">Friends &amp; relatives</a></li>
                    <li><a href="#">Notifications</a></li>
    	...
    	<div class="row">
            ...
            <div class="gallery-grid">
              ...
              <div class="gallery-grid-item">
              	<div class="framebox">
                    <span class="green-user"> <img src="images/green-users.png" alt="" /> </span>
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img src="images/video.jpg" alt=""> </div>
              ...
              <div class="gallery-grid-item gallery-grid-item-width2">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img class="thumbnail" src="images/1.jpg" alt=""> </div>
                    <div class="photocount">11/23</div>
               </div>
              </div>
              <div class="gallery-grid-item gallery-grid-item-width3">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img class="thumbnail " src="images/img-spncr-1.jpg" alt=""> </div>
              ...
              <div class="gallery-grid-item">
              	<div class="framebox">
                  <span class="green-user"> <img src="images/green-imguser.png" alt="" /> </span>
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img src="images/img-09.jpg" alt=""> </div>
                     <span class="plus-infobox">2 <i class=" glyphicon glyphicon-heart"></i></span>
                     <span class="heart-infobox">2 <i class="glyphicon glyphicon-option-horizontal"></i></span>
               </div>
              </div>
              <div class="gallery-grid-item">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img src="images/img-10.jpg" alt=""> </div>
                    <span class="plus-infobox">2 <i class=" glyphicon glyphicon-heart"></i></span>
                    <span class="heart-infobox">2 <i class="glyphicon glyphicon-option-horizontal"></i></span>
               </div>
              </div>
              <div class="gallery-grid-item gallery-grid-item-width3">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
                    <div class="framecontent"><img src="images/2.jpg" alt=""> </div>
                    <span class="plus-infobox">2 <i class=" glyphicon glyphicon-heart"></i></span>
                    <span class="heart-infobox">2 <i class="glyphicon glyphicon-option-horizontal"></i></span>
               </div>
              </div>
                    ...
                    <div class="carousel-inner" id="MemoryListDates">
                      <div class="thumbnail-carouselyear">
                        <div class="carousel slide" id="myCarouselYear">
                          ...
                          <a data-slide="prev" href="http://memorebook.com/smemore/EBook/TimeLine#myCarouselYear" class="left carousel-control">‹</a><a data-slide="next" href="http://memorebook.com/smemore/EBook/TimeLine#myCarouselYear" class="right carousel-control">›</a></div>
                      </div>
                    </div>
                </div>
