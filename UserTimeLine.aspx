...
<head >
  <meta charset="utf-8"/>
    ...
    <script  type="text/javascript" src="Scripts/UserTimeline.js"></script>
      ...
      <div class="container">
          ...
          <div class="pull-left">
              <div class="dropdown greenbottonholder">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dLabel" id="ul_MyFriendsList">
                    <li class="dropdown-header" onclick="AllFriends()" id="AllFriends" style="cursor:pointer"><i><img src="images/user-icon.png" alt="Friends & Relatives"></i> Friends & Relatives </li>
                    <ul id="namescroll">

                    <li><a  href="#">"No Friends Found"</a></li>
					</ul>
                    <li class="dropdown-footer"><a href="Friends-Relatives.aspx"><i> </i> <u>Add more</u></a></li>
                  </ul>
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav cusome-black">
          	<li>
                <a id="CurrentUser" style="width:150px" align="center">Friends & Relatives</a>
            </li>
          </ul>
    ...
    <nav id="mainheader-small" class="navbar navbar-default navbar-fixed-top hide-h">
     ...
     <div class="container">
    	<div class="row">
            ...
            <div class="gallery-grid" style="position: relative; height: 847px;">
              ...
              <div class="gallery-grid-item gallery-grid-item-width2" style="position: absolute; left: 36.9298%; top: 0px;">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
              ...
              <div class="gallery-grid-item gallery-grid-item-width3" style="position: absolute; left: 74.9123%; top: 0px;">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
              ...
              <div class="gallery-grid-item gallery-grid-item-width3" style="position: absolute; left: 74.9123%; top: 312px;">
              	<div class="framebox">
              ...
              <div class="gallery-grid-item" style="position: absolute; left: 0%; top: 413px;">
              	<div class="framebox">
              ...
              <div class="gallery-grid-item" style="position: absolute; left: 36.9298%; top: 573px;">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
              ...
              <div class="gallery-grid-item gallery-grid-item-width3" style="position: absolute; left: 73.9474%; top: 625px;">
              	<div class="framebox">
                	<div class="title">Marcus' First Steps!</div>
