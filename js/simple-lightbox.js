...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		nav = $('<div>').addClass('sl-navigation').html('<button class="sl-prev"><i class="glyphicon glyphicon-chevron-left"></i>'+options.navText[0]+'</button><button class="sl-next"><i class="glyphicon glyphicon-chevron-right"></i>'+options.navText[1]+'</button>'),
